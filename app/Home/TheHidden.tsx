...
export default function TheHidden() {
  return (
    <div className="relative  example">
      <div className="hidden-fee-bg   absolute top-0  w-full h-full z-[-20]"></div>
      ...
      <section className="max-w-[1280px] m-auto relative z-[999] h-screen w-screen">
        <h2 className="text-center font-heroFont text-5.5xl mt-16">
          No <span className="gradient-text">Hidden Fees</span>
        </h2>
        <p className="text-center mb-16">Free to start, pay as you scale</p>
        ...
        >
          <div className="backdrop-blur-[155px] bg-[#62777D] md:rounded-[20px] border-2 border-solid border-[#62777D] bg-gradient-to-br from-[#62777D] to-[#122836] fee-card text-left p-8 ">
            ...
            <p className="mb-12 text-xl text-[#A9AEB0] tablet:mb-3 ">
              We take payments daily as a percentage of sales - so you pay us as
              you earn.
            </p>
